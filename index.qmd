...
<p>Suppose a case has <b>50</b> contacts and <font color="#B25628"><b>10</b></font> of the contacts are <font color="#B25628">infected</font>.</p>

<p>For a 'narrow' contact definition e.g. <b>"Close, unprotected nursing care"</b> we may find that:

<img src = "plots/schematic_narrow.png" alt = "alternatetext" width="1000" >

<p>whereas for a 'broad' contact definition e.g. <b>"Brief face-to-face interaction"</b> we may find that:</p>

<img src = "plots/schematic_broad.png" alt = "alternatetext" width="1000" >
`
...
html`<p>Across the literature reviewed, a policy of tracing contacts classified as <b>'${contactType}'</b> would have resulted in:</p>

<p><i><b>Secondary attack rate:</b> <b>${sar}%</b> of traced contacts are infected</i></p>

<p><i><b>Sensitivity:</b> tracing <b>${sensitivity}%</b> of infected contacts; missing <b>${proportionMissed}%</b></i></p>

<p><i><b>Specificity:</b> not tracing <b>${specificity}%</b> of uninfected contacts (higher = better)</i></p>`
```
